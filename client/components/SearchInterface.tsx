...
export const SearchInterface: React.FC = () => {
  ...
  const handleSearch = async (searchQuery?: string) => {
    ...
    try {
      ...
      setSummary(
        "Based on your documents, I found several relevant sections covering employment benefits, data privacy policies, and payment terms. The information spans across multiple contracts and policy documents.",
      );
    } finally {
  ...
  return (
    <Card className="w-full">
      <CardHeader>
        ...
        <CardDescription>
          Ask questions in natural language and get intelligent answers from
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <div className="ml-auto">
                          <Badge variant="secondary" className="text-xs">
                            {Math.round(searchResults[0].relevanceScore * 100)}%
                            confidence
                          </Badge>
                        </div>
                      </div>
